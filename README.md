...
- Module Designer extensions: GIT instance add/remove (Q124), walkmesh face paint (Q126), full DLG graph depth (Q128)
- Archive Browser workspace for ERF/RIM/MOD member browse and extract (Q127)
