...
| --- | --- | --- | --- | --- |
| P1 | OpenKotOR parity program (PyKotor/Holocron) | Drive upstream parity in bounded Godot editor slices with matrix-driven backlog. | Q61 shipped Module Designer LYT preview export. | Next: advanced module designer tooling, utility panels, or parity wave items per master plan Phase C–E. |
