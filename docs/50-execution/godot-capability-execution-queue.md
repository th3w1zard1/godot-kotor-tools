...
| Q84 | Install ResRef references finder | `KotorResRefReferenceScanner` scans override GFF/NSS for resref hits; resource browser **Find References** action with formatted field-path report; headless `test_resref_reference_scanner.gd`. |
