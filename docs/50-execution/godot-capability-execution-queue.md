...
> **Branch note:** Q144 LTR depth via PR #135. Q145 chitin BIF catalog open as PR #136. Q146 CI open as PR #137. Drop `*(PR #119)*` qualifiers in queue rows when editing legacy entries.
