...
| Q86 | ModuleKit loader for Indoor Builder | `KotorModuleKitLoader` synthesizes kit components from module LYT rooms; Indoor Builder **Refresh Module Kits**; headless `test_module_kit_loader.gd`. |

## Active Slice

| Order | Capability slice | Goal | Readiness criteria | Notes |
| --- | --- | --- | --- | --- |
| P1 | OpenKotOR parity program (PyKotor/Holocron) | Drive upstream parity in bounded Godot editor slices with matrix-driven backlog. | Q86 shipped ModuleKit loader for Indoor Builder. | Next: references finder, batch TPC export, or parity wave items per master plan Phase C–E. |
