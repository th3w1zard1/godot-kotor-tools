...
| --- | --- | --- | --- | --- |
| P1 | OpenKotOR parity program (PyKotor/Holocron) | Drive upstream parity in bounded Godot editor slices with matrix-driven backlog. | Q92 shipped flat-folder MDL batch export. | Next: parity wave items per master plan Phase C–E. |
