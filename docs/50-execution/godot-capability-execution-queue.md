...
| Q85 | Install-scoped TPC batch export | `TpcGamefsBatchExporter` scans GameFS `.tpc` index and batch-exports TGA via PyKotor `texture-convert`; TPC editor **Batch Export Install TGA...** action; headless `test_tpc_gamefs_batch_exporter.gd`. |
