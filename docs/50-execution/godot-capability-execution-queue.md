...
| --- | --- | --- | --- | --- |
| P1 | OpenKotOR parity program (PyKotor/Holocron) | Drive upstream parity in bounded Godot editor slices with matrix-driven backlog. | Q82 shipped install-scoped GameFS batch image→TPC import. | Next: model helpers or parity wave items per master plan Phase C–E. |
