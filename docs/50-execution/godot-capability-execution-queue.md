...
| Q82 | Batch TGA/PNG to TPC converter | `TpcBatchConverter` flat-folder scan with native RGBA encode; TPC editor **Batch Convert TGA/PNG→TPC...** action; headless `test_tpc_batch_converter.gd`. |
