...
| --- | --- | --- | --- | --- |
| P1 | OpenKotOR parity program (PyKotor/Holocron) | Drive upstream parity in bounded Godot editor slices with matrix-driven backlog. | Q86 shipped native TPC DXT1/DXT5 encode. | Next: parity wave items per master plan Phase C–E. |
