...
| Q83 | Batch TPC to TGA export | `TpcBatchExporter` flat-folder scan with PyKotor `texture-convert` per file; TPC editor **Batch Export TGA...** action; headless `test_tpc_batch_exporter.gd`. |
