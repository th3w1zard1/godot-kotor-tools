...
| TPC | tpc, tga | Yes (`kotor.tpc`) | No | Yes (`TPCWriter` passthrough/RGBA/DXT1/DXT5 + pipeline validate; Q88/Q89/Q90 DXT encode/import) | Yes | Partial (Q30/Q86/Q88/Q89/Q90 write-back; DXT3 encode deferred) |
