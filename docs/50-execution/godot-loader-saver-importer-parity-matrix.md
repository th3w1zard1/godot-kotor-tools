...
| TPC | tpc, tga | Yes (`kotor.tpc`) | No | Yes (`TPCWriter` passthrough/RGBA/DXT1/DXT5 + pipeline validate; Q88 batch folder DXT encode) | Yes | Partial (Q30/Q86/Q88 write-back; DXT3 encode deferred) |
