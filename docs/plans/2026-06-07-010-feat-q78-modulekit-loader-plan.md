---
title: "feat: Q78 ModuleKit loader for Indoor Builder"
type: feat
status: completed
date: 2026-06-07
origin: lfg-next-after-q77-auto-selected
phase: Q78
...
# Q78: ModuleKit Loader for Indoor Builder
...
Q23 shipped on-disk indoor kit libraries. PyKotor `ModuleKit` dynamically builds kit components from game module LYT rooms (model + walkmesh footprint). Indoor Builder cannot reuse existing module rooms without manually recreating kits.
...
- Module kit auto-install / embedded component generation
...
| R6 | Docs mark Q78 shipped | Doc diff |
