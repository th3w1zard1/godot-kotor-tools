...
| P2 | Authoring ergonomics for complex typed docs | Shipped (Q6–Q10) | Reduces manual error risk in larger content edits. | Struct/array editing, typed pickers, enum registry, inventory arrays. |
...
1. **Execution queue:** [docs/50-execution/godot-capability-execution-queue.md](docs/50-execution/godot-capability-execution-queue.md) — Shipped slices (Q1–Q10) and deferred next slices with readiness criteria and dependencies.
