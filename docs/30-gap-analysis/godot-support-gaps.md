...
| Module Designer (GIT/PTH/LYT/VIS/WOK, instance CRUD, walkmesh paint) | **Partial** | Shipped on `main` (Q15–Q73, Q124–Q126) | Advanced BWM painter depth and native indoor `IndoorMap.build()` port remain deferred. |
...
1. **Execution queue:** [docs/50-execution/godot-capability-execution-queue.md](docs/50-execution/godot-capability-execution-queue.md) — Shipped slices (Q1–Q128c4 on `main`) and active/deferred next slices (Q130+) with readiness criteria and dependencies.
