...
| P2 | Authoring ergonomics for complex typed docs | Q7–Q8 (deferred) | Reduces manual error risk in larger content edits. | Add typed validation helpers plus EditorInspector-backed editors for common GFF structs/locstrings. |
...
1. **Execution queue:** [docs/50-execution/godot-capability-execution-queue.md](docs/50-execution/godot-capability-execution-queue.md) — Shipped slices (Q1–Q5) and deferred next slices (Q6–Q8) with readiness criteria and dependencies.
