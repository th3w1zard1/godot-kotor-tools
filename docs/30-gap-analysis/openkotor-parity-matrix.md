...
6. Media/tooling parity wave (TPC write-back, batch LIP tooling).
7. Module/area designer parity wave (native indoor build port, 3D rotate gizmo, LYT/walkmesh depth).
