...
| Texture/media editing | tpc/tga/dds/wav/lip/mdl surfaces | Partial | Q27–Q29 shipped SSF/TPC preview/WAV/LIP tooling. Q30 (shipped 2026-06-04): native `TPCWriter` passthrough + RGBA encode, Import TGA/PNG in TPC editor, pipeline `tpc` validation. Q77 (shipped 2026-06-07): `TpcBatchConverter` batch TGA/PNG→TPC from flat folders; TPC editor **Batch Convert TGA/PNG→TPC...**. DXT encode and batch LIP remain backlog. |
...
| Advanced utility tools | PyKotor tools (modulekit, references, texture batch, model helpers) | Partial | Q77 (shipped 2026-06-07): native batch TGA/PNG→TPC converter in TPC editor; see `docs/plans/2026-06-07-009-feat-q77-texture-batch-converter-plan.md`. Modulekit/references remain backlog. |
...
7. **Q77 (shipped 2026-06-07):** Batch TGA/PNG→TPC converter — `TpcBatchConverter` writes RGBA `.tpc` files from flat image folders; TPC editor batch toolbar action; see `docs/plans/2026-06-07-009-feat-q77-texture-batch-converter-plan.md`.
8. Media/tooling parity wave (DXT TPC encode, batch LIP tooling).
9. Module/area designer parity wave (native indoor build port, 3D rotate gizmo, LYT/walkmesh depth).
