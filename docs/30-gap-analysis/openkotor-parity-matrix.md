...
| Module/area designer workflows | Holocron module designer, indoor builder, walkmesh/lyt tools | Not started | Requires dedicated architecture and rendering/editor slices in Godot. |
...
- Workspace editors:
  - GFF-family entity editor (`utc`, `utp`, `uti`, `utd`, `ute`, `utm`, `uts`, `utt`, `utw`, `are`, `git`, `ifo`, `jrl`, `pth`, `fac`)
  - DLG editor
  - 2DA editor
  - TLK editor
  - NSS script editor
