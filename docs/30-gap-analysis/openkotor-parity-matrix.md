...
| Archive formats | ERF/RIM/MOD, BIF/KEY | Partial | ERF/RIM/MOD write-back shipped. Q127 *(PR #119)*: Archive Browser browse/extract. Q134–Q143 *(PRs #124–#133)*: add/remove/replace/save, member compare, install to modules, batch extract/export/compare, dirty path indicator on `main`. Q145: chitin BIF catalog listing + resource browser source/catalog filters. Q151–Q152 *(Wave B)*: BIF member/batch extract to override/folder, KEY inspector + chitin browser actions. |
| Savegame tooling | Holocron `savegame.py` | Partial | Q132 (shipped via PR #122): read-only `.sav` metadata workspace tab. Q147/Q149: extract members to override. Q153–Q154 planned: member edit + full SAV write-back (Wave C). |
