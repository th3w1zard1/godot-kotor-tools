...
| Advanced utility tools | PyKotor tools (modulekit, references, texture batch, model helpers) | Partial | Q76 (shipped 2026-06-07): override-scoped ResRef references finder in workspace resource browser; see `docs/plans/2026-06-07-008-feat-q76-resref-references-finder-plan.md`. Q77 (shipped 2026-06-07): native batch TGA/PNG→TPC converter in TPC editor; see `docs/plans/2026-06-07-009-feat-q77-texture-batch-converter-plan.md`. Q78 (shipped 2026-06-07): `KotorModuleKitLoader` exposes module LYT rooms as Indoor Builder kits with **Refresh Module Kits**; see `docs/plans/2026-06-07-010-feat-q78-modulekit-loader-plan.md`. Q79 (shipped 2026-06-07): batch TPC→TGA export in TPC editor; see `docs/plans/2026-06-07-011-feat-q79-batch-tpc-export-plan.md`. Q81 (shipped 2026-06-07): install-scoped GameFS TPC batch export; see `docs/plans/2026-06-07-013-feat-q81-gamefs-tpc-batch-export-plan.md`. Q82 (shipped 2026-06-10): install-scoped GameFS TGA/PNG→TPC batch import; see `docs/plans/2026-06-10-014-feat-q82-gamefs-tpc-batch-import-plan.md`. Model helpers remain backlog. |
...
57. Module/area designer parity wave (model helpers).
