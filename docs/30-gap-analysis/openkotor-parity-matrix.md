...
| Texture/media editing | tpc/tga/dds/wav/lip/mdl surfaces | Partial | Q27–Q29 shipped SSF/TPC preview/WAV/LIP tooling. Q30 (shipped 2026-06-04): native `TPCWriter` passthrough + RGBA encode, Import TGA/PNG in TPC editor, pipeline `tpc` validation. DXT encode and batch LIP remain backlog. |
...
7. **Q86 (shipped 2026-06-07):** ModuleKit loader — module LYT rooms surface as Indoor Builder kits; see `docs/plans/2026-06-07-018-feat-q86-modulekit-loader-plan.md`.
