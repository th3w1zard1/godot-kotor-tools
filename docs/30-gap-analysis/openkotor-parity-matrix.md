...
- Workspace editors:
  ...
  - Indoor Builder (`.indoor` JSON layout: room map, tree, Holocron kit library, filesystem save)
  - DLG editor
  - 2DA editor
  - TLK editor
  - NSS script editor
