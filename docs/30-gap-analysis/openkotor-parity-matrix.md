...
| Patching/diff tooling parity | HoloPatcher, KotorDiff | Partial | Q32 (shipped 2026-06-04): semantic GFF-family compare reports in install diff (`GFFCompare`); 2DA/TLK semantic compare pre-existing. Full KotorDiff UI / HoloPatcher remain backlog. |
