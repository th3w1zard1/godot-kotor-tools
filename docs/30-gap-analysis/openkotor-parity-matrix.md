...
| Patching/diff tooling parity | HoloPatcher, KotorDiff | Partial | Q32–Q37 semantic compare for GFF/SSF/LIP/TPC plus 2DA/TLK; install diff reports label header/slot/keyframe changes. Full KotorDiff UI / HoloPatcher remain backlog. |
...
13. Module/area designer parity wave (native indoor build port, 3D rotate gizmo, LYT/walkmesh depth).
