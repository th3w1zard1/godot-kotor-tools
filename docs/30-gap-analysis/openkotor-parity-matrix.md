...
| Advanced utility tools | PyKotor tools (modulekit, references, texture batch, model helpers) | Partial | Q76 (shipped 2026-06-07): override-scoped ResRef references finder in workspace resource browser; see `docs/plans/2026-06-07-008-feat-q76-resref-references-finder-plan.md`. Q77 (shipped 2026-06-07): native batch TGA/PNG→TPC converter in TPC editor; see `docs/plans/2026-06-07-009-feat-q77-texture-batch-converter-plan.md`. Modulekit remains backlog. |
...
53. Module/area designer parity wave (advanced tooling, utility panels).
